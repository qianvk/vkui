...
QPainterPath VPopoverPath::create(const VPopoverPathInput& input) {
    ...
    if (input.placement == VPopoverPlacement::Automatic) {
        return roundedBody(body, radius);
    }

    const bool vertical = input.placement == VPopoverPlacement::Below ||
                          input.placement == VPopoverPlacement::Above;
    ...
    if (vertical) {
        ...
        if (input.placement == VPopoverPlacement::Below) {
        ...
        if (input.placement == VPopoverPlacement::Right) {
