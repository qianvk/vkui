...
class VkPopupSurfaceStyler final : public QObject {
  ...
  private:
    ...
    static QComboBox* ownerComboBox(QWidget* popup) {
        for (QObject* object = popup ? popup->parent() : nullptr; object;
...
void VkStyle::drawPrimitive(PrimitiveElement element, const QStyleOption* option, QPainter* painter,
    ...
    case PE_PanelButtonCommand: {
        ...
        const QColor emphasizedHover =
            destructiveButton ? VkStylePainter::mix(colors.destructive, colors.textPrimary, 0.12)
        ...
        QColor border = VkStylePainter::mix(
            colors.border, VkStylePainter::mix(emphasizedFill, colors.borderStrong, 0.22),
            emphasis);
        if (!enabled) {
...
void VkStyle::drawControl(ControlElement element, const QStyleOption* option, QPainter* painter,
    ...
    case CE_PushButtonLabel: {
        ...
        copy.palette.setColor(QPalette::ButtonText,
                              enabled
                                  ? (emphasized ? VkStylePainter::contrastingText(emphasizedFill)
                                                : colors.textPrimary)
                                  : colors.textDisabled);
