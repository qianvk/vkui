...
VkSlider::VkSlider(QWidget* parent) : VkSlider(Qt::Vertical, parent) {}

VkSlider::VkSlider(Qt::Orientation orientation, QWidget* parent)
    : QSlider(orientation, parent), d(std::make_unique<VkSliderPrivate>()) {}

VkSlider::~VkSlider() = default;

void VkSlider::mousePressEvent(QMouseEvent* event) {
...
void VkSlider::mouseMoveEvent(QMouseEvent* event) {
...
void VkSlider::mouseReleaseEvent(QMouseEvent* event) {
